...
**Always** use [docs/blog-style-guide.md](../../docs/blog-style-guide.md) as the source of truth for:
...
1. **If the post file exists:** Open `content/blog/<slug>/index.md` and (if needed) read [docs/blog-style-guide.md](../../docs/blog-style-guide.md). Apply the checklist from the style guide when suggesting changes.
